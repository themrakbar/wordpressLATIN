...
const overlayRegistry = [{
  ...
  shouldRender: ({
    element,
    isSelected
  }) => isSelected && element.dataset.eType === 'e-grid'
}];
...
/* harmony import */ var _hooks_use_element_rect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../hooks/use-element-rect */ "./packages/packages/core/editor-canvas/src/hooks/use-element-rect.ts");
/* harmony import */ var _hooks_use_floating_on_element__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../hooks/use-floating-on-element */ "./packages/packages/core/editor-canvas/src/hooks/use-floating-on-element.ts");
/* harmony import */ var _hooks_use_grid_tracks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/use-grid-tracks */ "./packages/packages/core/editor-canvas/src/hooks/use-grid-tracks.ts");
/* harmony import */ var _outline_overlay__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../outline-overlay */ "./packages/packages/core/editor-canvas/src/components/outline-overlay.tsx");
/* harmony import */ var _grid_outline__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./grid-outline */ "./packages/packages/core/editor-canvas/src/components/grid-outline/grid-outline.tsx");
...
const GridOutlineOverlay = ({
  ...
  const {
    settings
  } = (0,_elementor_editor_elements__WEBPACK_IMPORTED_MODULE_1__.useSelectedElementSettings)();
  const enabled = _elementor_editor_props__WEBPACK_IMPORTED_MODULE_2__.booleanPropTypeUtil.extract(settings?.grid_outline);
  const rect = (0,_hooks_use_element_rect__WEBPACK_IMPORTED_MODULE_5__.useElementRect)(element);
  const tracks = (0,_hooks_use_grid_tracks__WEBPACK_IMPORTED_MODULE_7__.useGridTracks)(element, rect);
  const {
    floating
  } = (0,_hooks_use_floating_on_element__WEBPACK_IMPORTED_MODULE_6__.useFloatingOnElement)({
    element,
    isSelected
  });
  if (enabled === false) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_floating_ui_react__WEBPACK_IMPORTED_MODULE_4__.FloatingPortal, {
    id: _outline_overlay__WEBPACK_IMPORTED_MODULE_8__.CANVAS_WRAPPER_ID
    ...
    role: "presentation"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_grid_outline__WEBPACK_IMPORTED_MODULE_9__.GridOutline, {
    element: element,
    tracks: tracks,
    width: rect.width,
    height: rect.height
...
function GridOutline({
  ...
  }, hasGap ? renderCells(cells, tracks.borderColor) : renderLines(tracks, width, height)), emptyCellRect && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_first_empty_cell__WEBPACK_IMPORTED_MODULE_4__.FirstEmptyCell, {
    rect: emptyCellRect,
    color: tracks.borderColor
  }));
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GridOutlineOverlay: function() { return /* reexport safe */ _grid_outline_overlay__WEBPACK_IMPORTED_MODULE_0__.GridOutlineOverlay; }
/* harmony export */ });
/* harmony import */ var _grid_outline_overlay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./grid-outline-overlay */ "./packages/packages/core/editor-canvas/src/components/grid-outline/grid-outline-overlay.tsx");
...
/* harmony import */ var _mcp_utils_do_update_element_property__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mcp/utils/do-update-element-property */ "./packages/packages/core/editor-canvas/src/mcp/utils/do-update-element-property.ts");
/* harmony import */ var _mcp_utils_merge_custom_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mcp/utils/merge-custom-css */ "./packages/packages/core/editor-canvas/src/mcp/utils/merge-custom-css.ts");
/* harmony import */ var _utils_required_children_enforcer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/required-children-enforcer */ "./packages/packages/core/editor-canvas/src/composition-builder/utils/required-children-enforcer.ts");
/* harmony import */ var _utils_required_default_child_tags__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/required-default-child-tags */ "./packages/packages/core/editor-canvas/src/composition-builder/utils/required-default-child-tags.ts");
...
class CompositionBuilder {
  ...
  api = {
    ...
    doUpdateElementProperty: _mcp_utils_do_update_element_property__WEBPACK_IMPORTED_MODULE_1__.doUpdateElementProperty
  };
  ...
  async applyProperties() {
    ...
    for (const configId of allConfigIds) {
      ...
      const mergedCustomCss = (0,_mcp_utils_merge_custom_css__WEBPACK_IMPORTED_MODULE_2__.mergeCustomCssText)(this.elementCustomCSS[configId], fallbackCss);
      if (mergedCustomCss) {
        try {
          this.api.doUpdateElementProperty({
            elementId: element.id,
  ...
  async build(rootContainer) {
    ...
    const typesWithRequiredChildren = Object.keys(widgetsCache).filter(elementType => (0,_utils_required_default_child_tags__WEBPACK_IMPORTED_MODULE_4__.getRequiredDefaultChildTemplates)(widgetsCache[elementType]).length > 0);
    typesWithRequiredChildren.forEach(elementType => {
      new _utils_required_children_enforcer__WEBPACK_IMPORTED_MODULE_3__.RequiredChildrenEnforcer(elementType, widgetsCache).enforce(this.xml);
    });
...
function blockFormFieldCreate(args) {
  ...
  if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isWithinForm)(args.container)) {
...
function blockFormFieldMove(args) {
  ...
  const hasFormFieldElement = containers.some(container => container ? (0,_utils__WEBPACK_IMPORTED_MODULE_3__.hasElementTypes)(container, _utils__WEBPACK_IMPORTED_MODULE_3__.FORM_FIELD_ELEMENT_TYPES) : false);
  if (hasFormFieldElement && !(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isWithinForm)(target) && !(0,_utils__WEBPACK_IMPORTED_MODULE_3__.movedContainersIncludeAtomicFormRoot)(containers)) {
    handleBlockedFormField();
    return true;
  }
  return false;
...
/* harmony import */ var _elementor_editor_elements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @elementor/editor-elements */ "@elementor/editor-elements");
/* harmony import */ var _elementor_editor_elements__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_elementor_editor_elements__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _composition_builder_composition_builder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../composition-builder/composition-builder */ "./packages/packages/core/editor-canvas/src/composition-builder/composition-builder.ts");
/* harmony import */ var _resources_available_widgets_resource__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../resources/available-widgets-resource */ "./packages/packages/core/editor-canvas/src/mcp/resources/available-widgets-resource.ts");
/* harmony import */ var _resources_dynamic_tags_resource__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../resources/dynamic-tags-resource */ "./packages/packages/core/editor-canvas/src/mcp/resources/dynamic-tags-resource.ts");
/* harmony import */ var _resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../resources/widgets-schema-resource */ "./packages/packages/core/editor-canvas/src/mcp/resources/widgets-schema-resource.ts");
/* harmony import */ var _utils_convert_css_to_atomic__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/convert-css-to-atomic */ "./packages/packages/core/editor-canvas/src/mcp/utils/convert-css-to-atomic.ts");
/* harmony import */ var _utils_element_data_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils/element-data-util */ "./packages/packages/core/editor-canvas/src/mcp/utils/element-data-util.ts");
/* harmony import */ var _utils_get_composition_target_container__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/get-composition-target-container */ "./packages/packages/core/editor-canvas/src/mcp/utils/get-composition-target-container.ts");
/* harmony import */ var _prompt__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./prompt */ "./packages/packages/core/editor-canvas/src/mcp/tools/build-composition/prompt.ts");
/* harmony import */ var _schema__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./schema */ "./packages/packages/core/editor-canvas/src/mcp/tools/build-composition/schema.ts");
/* harmony import */ var _xml_leaf_wrapper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./xml-leaf-wrapper */ "./packages/packages/core/editor-canvas/src/mcp/tools/build-composition/xml-leaf-wrapper.ts");
...
const initBuildCompositionsTool = reg => {
  ...
  resource('build-compositions-guide', _prompt__WEBPACK_IMPORTED_MODULE_9__.BUILD_COMPOSITIONS_GUIDE_URI, {
    ...
    contents: [{
      uri: uri.href,
      mimeType: 'text/plain',
      text: (0,_prompt__WEBPACK_IMPORTED_MODULE_9__.generatePrompt)()
    }]
  }));
  addTool({
    ...
    schema: _schema__WEBPACK_IMPORTED_MODULE_10__.inputSchema,
    requiredResources: [{
      description: 'Build compositions guide',
      uri: _prompt__WEBPACK_IMPORTED_MODULE_9__.BUILD_COMPOSITIONS_GUIDE_URI
    }, {
      description: 'Widgets schema',
      uri: _resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_5__.WIDGET_SCHEMA_URI
    }, {
      ...
      uri: _resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_5__.BEST_PRACTICES_URI
    }, {
      description: 'Available widgets for this tool',
      uri: _resources_available_widgets_resource__WEBPACK_IMPORTED_MODULE_3__.AVAILABLE_WIDGETS_URI_V4
    }, {
      description: 'Dynamic tags catalog',
      uri: _resources_dynamic_tags_resource__WEBPACK_IMPORTED_MODULE_4__.DYNAMIC_TAGS_URI
    }],
    outputSchema: _schema__WEBPACK_IMPORTED_MODULE_10__.outputSchema,
    handler: async rawParams => {
      ...
      const {
        ...
        elementConfig,
        stylesConfig
      } = (0,_xml_leaf_wrapper__WEBPACK_IMPORTED_MODULE_11__.adaptLeafRootParams)({
        ...rawParams,
        stylesConfig: convertedStyles,
      ...
      const targetContainer = (0,_utils_get_composition_target_container__WEBPACK_IMPORTED_MODULE_8__.getCompositionTargetContainer)(documentContainer, currentDocument?.type.value);
      try {
        const compositionBuilder = _composition_builder_composition_builder__WEBPACK_IMPORTED_MODULE_2__.CompositionBuilder.fromXMLString(xmlStructure, {
...
async function convertCompositionStyles(style) {
  ...
  const results = await (0,_utils_convert_css_to_atomic__WEBPACK_IMPORTED_MODULE_6__.convertStyleBlocksToAtomic)(style);
  for (const [configId, {
    props,
    customCss
...
function assertCompositionXmlUsesV4WidgetsOnly(xmlStructure) {
  ...
  for (const node of doc.querySelectorAll('*')) {
    ...
    if (!(0,_utils_element_data_util__WEBPACK_IMPORTED_MODULE_7__.isWidgetAvailableForLLM)(widgetData) || !widgetData.atomic_props_schema) {
...
/* harmony import */ var _resources_dynamic_tags_resource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../resources/dynamic-tags-resource */ "./packages/packages/core/editor-canvas/src/mcp/resources/dynamic-tags-resource.ts");
/* harmony import */ var _resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../resources/widgets-schema-resource */ "./packages/packages/core/editor-canvas/src/mcp/resources/widgets-schema-resource.ts");
/* harmony import */ var _utils_convert_css_to_atomic__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/convert-css-to-atomic */ "./packages/packages/core/editor-canvas/src/mcp/utils/convert-css-to-atomic.ts");
/* harmony import */ var _utils_do_update_element_property__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/do-update-element-property */ "./packages/packages/core/editor-canvas/src/mcp/utils/do-update-element-property.ts");
/* harmony import */ var _utils_resolve_canonical_prop_name__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/resolve-canonical-prop-name */ "./packages/packages/core/editor-canvas/src/mcp/utils/resolve-canonical-prop-name.ts");
/* harmony import */ var _prompt__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./prompt */ "./packages/packages/core/editor-canvas/src/mcp/tools/configure-element/prompt.ts");
/* harmony import */ var _schema__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./schema */ "./packages/packages/core/editor-canvas/src/mcp/tools/configure-element/schema.ts");
...
const initConfigureElementTool = reg => {
  ...
  resource('configure-element-guide', _prompt__WEBPACK_IMPORTED_MODULE_7__.CONFIGURE_ELEMENT_GUIDE_URI, {
    ...
    contents: [{
      uri: uri.href,
      mimeType: 'text/plain',
      text: (0,_prompt__WEBPACK_IMPORTED_MODULE_7__.generatePrompt)()
    }]
  }));
  addTool({
    name: 'configure-element',
    description: "Configure an existing V4 element's properties and styles. Read the guide resource before use.",
    schema: _schema__WEBPACK_IMPORTED_MODULE_8__.inputSchema,
    outputSchema: _schema__WEBPACK_IMPORTED_MODULE_8__.outputSchema,
    requiredResources: [{
      description: 'Widgets schema',
      uri: _resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_3__.WIDGET_SCHEMA_URI
    }, {
      description: 'Configure element guide',
      uri: _prompt__WEBPACK_IMPORTED_MODULE_7__.CONFIGURE_ELEMENT_GUIDE_URI
    }, {
      description: 'Dynamic tags catalog',
      uri: _resources_dynamic_tags_resource__WEBPACK_IMPORTED_MODULE_2__.DYNAMIC_TAGS_URI
    }],
    handler: async ({
      elementId,
      propertiesToChange,
      ...
      const propertiesToUpdate = (0,_utils_resolve_canonical_prop_name__WEBPACK_IMPORTED_MODULE_6__.resolveCanonicalPropKeys)(elementType, propertiesToChange);
      const toUpdate = Object.entries(propertiesToUpdate);
      for (const [propertyName, propertyValue] of toUpdate) {
        if (!_elementor_editor_props__WEBPACK_IMPORTED_MODULE_1__.Schema.isPropKeyConfigurable(propertyName)) {
          throw new Error(`Not allowed to update ${propertyName}`);
        }
        try {
          (0,_utils_do_update_element_property__WEBPACK_IMPORTED_MODULE_5__.doUpdateElementProperty)({
            elementId,
            elementType,
            propertyName,
            propertyValue
...
async function applyStyleFromCss(opts) {
  ...
  const {
    props,
    customCss
  } = await (0,_utils_convert_css_to_atomic__WEBPACK_IMPORTED_MODULE_4__.convertCssToAtomic)(style);
  const styleValue = {
    ...props
  };
  if (customCss) {
...
${propertyType === 'prop' ? `
Check the element's PropType schema at the resource [${_resources_widgets_schema_resource__WEBPACK_IMPORTED_MODULE_3__.WIDGET_SCHEMA_URI.replace('{widgetType}', elementType)}] for type "${elementType}" to ensure the property exists and the value matches the expected PropType.
