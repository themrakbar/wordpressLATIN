...
/* harmony import */ var _utils_tracking__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/tracking */ "./packages/packages/core/editor-variables/src/utils/tracking.ts");
/* harmony import */ var _utils_validations__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/validations */ "./packages/packages/core/editor-variables/src/utils/validations.ts");
/* harmony import */ var _fields_label_field__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./fields/label-field */ "./packages/packages/core/editor-variables/src/components/fields/label-field.tsx");
/* harmony import */ var _ui_form_field__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ui/form-field */ "./packages/packages/core/editor-variables/src/components/ui/form-field.tsx");
...
const VariableCreation = ({
  ...
  const {
    labelFieldError,
    setLabelFieldError
  } = (0,_fields_label_field__WEBPACK_IMPORTED_MODULE_12__.useLabelError)();
  const resetFields = () => {
    setValue('');
    setLabel('');
    setErrorMessage('');
  ...
  const handleCreateAndTrack = () => {
    (0,_hooks_use_prop_variables__WEBPACK_IMPORTED_MODULE_8__.createVariable)({
      ...
      const mappedError = (0,_utils_validations__WEBPACK_IMPORTED_MODULE_11__.mapServerError)(error);
      ...
      setErrorMessage(_utils_validations__WEBPACK_IMPORTED_MODULE_11__.ERROR_MESSAGES.UNEXPECTED_ERROR);
    });
    (0,_utils_tracking__WEBPACK_IMPORTED_MODULE_10__.trackVariableEvent)({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_elementor_editor_ui__WEBPACK_IMPORTED_MODULE_2__.SectionPopoverBody, {
    ...
    p: 2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ui_form_field__WEBPACK_IMPORTED_MODULE_13__.FormField, {
    id: "variable-label",
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Name', 'elementor'),
    errorMsg: labelFieldError?.message,
    noticeMsg: (0,_utils_validations__WEBPACK_IMPORTED_MODULE_11__.labelHint)(label)
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_fields_label_field__WEBPACK_IMPORTED_MODULE_12__.LabelField, {
    id: "variable-label",
    value: label,
    ...
    focusOnShow: true
  })), ValueField && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ui_form_field__WEBPACK_IMPORTED_MODULE_13__.FormField, {
...
const VariableEdit = ({
  ...
  const handleSaveVariable = () => {
    ...
    (0,_hooks_use_prop_variables__WEBPACK_IMPORTED_MODULE_9__.updateVariable)(editId, updatePayload).then(() => {
...
const createVariable = newVariable => {
  return _service__WEBPACK_IMPORTED_MODULE_3__.service.create(newVariable).then(extractId);
};
...
/* harmony import */ var _controls_variable_control__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controls/variable-control */ "./packages/packages/core/editor-variables/src/controls/variable-control.tsx");
/* harmony import */ var _hooks_use_prop_variable_action__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./hooks/use-prop-variable-action */ "./packages/packages/core/editor-variables/src/hooks/use-prop-variable-action.tsx");
/* harmony import */ var _mcp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mcp */ "./packages/packages/core/editor-variables/src/mcp/index.ts");
/* harmony import */ var _register_variable_types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./register-variable-types */ "./packages/packages/core/editor-variables/src/register-variable-types.tsx");
/* harmony import */ var _renderers_style_variables_renderer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./renderers/style-variables-renderer */ "./packages/packages/core/editor-variables/src/renderers/style-variables-renderer.tsx");
/* harmony import */ var _repeater_injections__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./repeater-injections */ "./packages/packages/core/editor-variables/src/repeater-injections.ts");
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./service */ "./packages/packages/core/editor-variables/src/service.ts");
...
function init() {
  (0,_register_variable_types__WEBPACK_IMPORTED_MODULE_9__.registerVariableTypes)();
  (0,_repeater_injections__WEBPACK_IMPORTED_MODULE_11__.registerRepeaterInjections)();
  (0,_elementor_editor_controls__WEBPACK_IMPORTED_MODULE_1__.registerControlReplacement)({
    component: _controls_variable_control__WEBPACK_IMPORTED_MODULE_6__.VariableControl,
    condition: ({
      value,
      placeholder
    }) => {
  ...
  registerPopoverAction({
    id: 'variables',
    priority: 40,
    useProps: _hooks_use_prop_variable_action__WEBPACK_IMPORTED_MODULE_7__.usePropVariableAction
  });
  _service__WEBPACK_IMPORTED_MODULE_12__.service.init();
...
`
  ...
  (0,_mcp__WEBPACK_IMPORTED_MODULE_8__.initMcp)(variablesMcpRegistry, (0,_elementor_editor_mcp__WEBPACK_IMPORTED_MODULE_2__.getMCPByDomain)('canvas'));
  (0,_elementor_editor__WEBPACK_IMPORTED_MODULE_0__.injectIntoTop)({
    id: 'canvas-style-variables-render',
    component: _renderers_style_variables_renderer__WEBPACK_IMPORTED_MODULE_10__.StyleVariablesRenderer
  });
...
function hasVariableAssigned(value) {
  if ((0,_elementor_editor_props__WEBPACK_IMPORTED_MODULE_3__.isTransformable)(value)) {
    return (0,_variables_registry_variable_type_registry__WEBPACK_IMPORTED_MODULE_13__.hasVariableType)(value.$$type);
  }
  return false;
}
