...
/* harmony import */ var _save_global_classes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../save-global-classes */ "./packages/packages/core/editor-global-classes/src/save-global-classes.tsx");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../store */ "./packages/packages/core/editor-global-classes/src/store.ts");
/* harmony import */ var _utils_tracking__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/tracking */ "./packages/packages/core/editor-global-classes/src/utils/tracking.ts");
/* harmony import */ var _search_and_filter_components_filter_active_filters__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../search-and-filter/components/filter/active-filters */ "./packages/packages/core/editor-global-classes/src/components/search-and-filter/components/filter/active-filters.tsx");
/* harmony import */ var _search_and_filter_components_filter_css_class_filter__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../search-and-filter/components/filter/css-class-filter */ "./packages/packages/core/editor-global-classes/src/components/search-and-filter/components/filter/css-class-filter.tsx");
/* harmony import */ var _search_and_filter_components_search_class_manager_search__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../search-and-filter/components/search/class-manager-search */ "./packages/packages/core/editor-global-classes/src/components/search-and-filter/components/search/class-manager-search.tsx");
/* harmony import */ var _search_and_filter_context__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../search-and-filter/context */ "./packages/packages/core/editor-global-classes/src/components/search-and-filter/context.tsx");
/* harmony import */ var _class_manager_introduction__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./class-manager-introduction */ "./packages/packages/core/editor-global-classes/src/components/class-manager/class-manager-introduction.tsx");
/* harmony import */ var _delete_class__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./delete-class */ "./packages/packages/core/editor-global-classes/src/components/class-manager/delete-class.ts");
/* harmony import */ var _flipped_color_swatch_icon__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./flipped-color-swatch-icon */ "./packages/packages/core/editor-global-classes/src/components/class-manager/flipped-color-swatch-icon.tsx");
/* harmony import */ var _global_classes_list__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./global-classes-list */ "./packages/packages/core/editor-global-classes/src/components/class-manager/global-classes-list.tsx");
/* harmony import */ var _panel_interactions__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./panel-interactions */ "./packages/packages/core/editor-global-classes/src/components/class-manager/panel-interactions.ts");
/* harmony import */ var _start_sync_to_v3_modal__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./start-sync-to-v3-modal */ "./packages/packages/core/editor-global-classes/src/components/class-manager/start-sync-to-v3-modal.tsx");
...
function ClassManagerPanelContent({
  ...
  const resetAndClosePanel = () => {
    (0,_elementor_store__WEBPACK_IMPORTED_MODULE_6__.__dispatch)(_store__WEBPACK_IMPORTED_MODULE_13__.slice.actions.resetToInitialState({
      context: 'frontend'
    }));
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    (0,_panel_interactions__WEBPACK_IMPORTED_MODULE_23__.blockPanelInteractions)();
    return () => {
      (0,_panel_interactions__WEBPACK_IMPORTED_MODULE_23__.unblockPanelInteractions)();
    };
  }, []);
  const handleStopSync = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(classId => {
    (0,_elementor_store__WEBPACK_IMPORTED_MODULE_6__.__dispatch)(_store__WEBPACK_IMPORTED_MODULE_13__.slice.actions.update({
      style: {
        id: classId,
        sync_to_v3: false
      }
    }));
    (0,_utils_tracking__WEBPACK_IMPORTED_MODULE_14__.trackGlobalClasses)({
      event: 'classSyncToV3',
      classId,
      action: 'unsync'
    });
  ...
  const handleStartSync = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(classId => {
    (0,_elementor_store__WEBPACK_IMPORTED_MODULE_6__.__dispatch)(_store__WEBPACK_IMPORTED_MODULE_13__.slice.actions.update({
      style: {
        id: classId,
        sync_to_v3: true
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_search_and_filter_context__WEBPACK_IMPORTED_MODULE_18__.SearchAndFilterProvider, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_elementor_ui__WEBPACK_IMPORTED_MODULE_7__.Stack, {
    direction: "column",
    sx: {
      height: '100%',
      width: '100%',
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_global_classes_list__WEBPACK_IMPORTED_MODULE_22__.GlobalClassesList, {
...
const usePublish = () => {
  return (0,_elementor_query__WEBPACK_IMPORTED_MODULE_5__.useMutation)({
    mutationFn: () => (0,_save_global_classes__WEBPACK_IMPORTED_MODULE_12__.saveGlobalClasses)({
      context: 'frontend'
    }),
    onSuccess: async () => {
      (0,_elementor_editor_documents__WEBPACK_IMPORTED_MODULE_2__.setDocumentModifiedStatus)(false);
      if ((0,_delete_class__WEBPACK_IMPORTED_MODULE_20__.hasDeletedItems)()) {
        await (0,_delete_class__WEBPACK_IMPORTED_MODULE_20__.onDelete)();
      }
    }
  });
};
...
const StopSyncConfirmationDialog = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_elementor_editor_ui__WEBPACK_IMPORTED_MODULE_4__.ConfirmationDialog, {
    ...
    icon: _flipped_color_swatch_icon__WEBPACK_IMPORTED_MODULE_21__.FlippedColorSwatchIcon,
    iconColor: "primary"
...
/* harmony import */ var _apply_global_class_guide_prompt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./apply-global-class-guide-prompt */ "./packages/packages/core/editor-global-classes/src/mcp-integration/apply-global-class-guide-prompt.ts");
/* harmony import */ var _classes_resource__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./classes-resource */ "./packages/packages/core/editor-global-classes/src/mcp-integration/classes-resource.ts");
...
function initMcpApplyUnapplyGlobalClasses(server) {
  ...
  const applyGlobalClassGuideText = (0,_apply_global_class_guide_prompt__WEBPACK_IMPORTED_MODULE_2__.generateApplyGlobalClassGuidePrompt)();
  resource('apply-global-class-guide', _apply_global_class_guide_prompt__WEBPACK_IMPORTED_MODULE_2__.APPLY_GLOBAL_CLASS_GUIDE_URI, {
  ...
  addTool({
    ...
    description: `Apply a global class to an element for shared design-system styling. Read the full guide at [${_apply_global_class_guide_prompt__WEBPACK_IMPORTED_MODULE_2__.APPLY_GLOBAL_CLASS_GUIDE_URI}].`,
    requiredResources: [{
      description: 'Apply global class tool guide',
      uri: _apply_global_class_guide_prompt__WEBPACK_IMPORTED_MODULE_2__.APPLY_GLOBAL_CLASS_GUIDE_URI
    }, {
      description: 'Global classes list',
      uri: _classes_resource__WEBPACK_IMPORTED_MODULE_3__.GLOBAL_CLASSES_URI
    }],
  ...
  addTool({
    ...
    description: `Unapply a global class from an element by class ID. Resolve class names to IDs via [${_classes_resource__WEBPACK_IMPORTED_MODULE_3__.GLOBAL_CLASSES_URI}].`,
    requiredResources: [{
      description: 'Global classes list',
      uri: _classes_resource__WEBPACK_IMPORTED_MODULE_3__.GLOBAL_CLASSES_URI
    }],
...
/* harmony import */ var _save_global_classes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../save-global-classes */ "./packages/packages/core/editor-global-classes/src/save-global-classes.tsx");
/* harmony import */ var _classes_resource__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./classes-resource */ "./packages/packages/core/editor-global-classes/src/mcp-integration/classes-resource.ts");
...
const schema = {
  action: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.enum(['create', 'modify', 'delete']).describe('Operation to perform'),
  classId: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().optional().describe('Global class ID (required for modify). Get from elementor://global-classes resource.'),
  globalClassName: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().optional().describe('Global class name (required for create)'),
  style: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.object({
    default: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().describe('Plaintext CSS for the default state. MUST be non-empty — blank strings are rejected.'),
    hover: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().describe('Plaintext CSS for the :hover state. optional').optional(),
    focus: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().describe('Plaintext CSS for the :focus state. optional').optional(),
    active: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().describe('Plaintext CSS for the :active state. optional').optional()
  ...
  breakpoint: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.nullable(_elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().describe('Responsive breakpoint name for styles. Defaults to desktop (null).')).default(null).describe('Responsive breakpoint name for styles. Defaults to desktop (null).')
};
const outputSchema = {
  status: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.enum(['ok', 'error']).describe('Operation status'),
  classId: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().optional().describe('Class ID (returned on create success)'),
  message: _elementor_schema__WEBPACK_IMPORTED_MODULE_1__.z.string().optional().describe('Error details if status is error')
};
const handler = async input => {
  ...
  const {
    ...
    update,
    delete: deleteClass
  } = _global_classes_styles_provider__WEBPACK_IMPORTED_MODULE_2__.globalClassesStylesProvider.actions;
  ...
  try {
    if (action === 'delete') {
      const deleted = await attemptDelete({
        classId,
        stylesProvider: _global_classes_styles_provider__WEBPACK_IMPORTED_MODULE_2__.globalClassesStylesProvider
      });
      if (deleted) {
        return {
          status: 'ok',
...
const initManageGlobalClasses = reg => {
  ...
  addTool({
    ...
    requiredResources: [{
      uri: _classes_resource__WEBPACK_IMPORTED_MODULE_5__.GLOBAL_CLASSES_URI,
      description: 'Global classes list'
    }, {
...
async function attemptCreate(opts) {
  ...
  try {
    await (0,_save_global_classes__WEBPACK_IMPORTED_MODULE_4__.saveGlobalClasses)({
      context: 'frontend'
    });
    return newClassId;
  } catch {
...
async function attemptUpdate(opts) {
  ...
  await (0,_load_existing_classes__WEBPACK_IMPORTED_MODULE_3__.loadExistingClasses)([classId]);
